...
public class L {
    ...
    // 默认支持解析库
    public static final Class<?>[] SUPPORT_CLASS = new Class[]{Bundle.class, Intent.class, Collection.class,
            Map.class, Throwable.class, Reference.class, Message.class, Activity.class, JSONArray.class,
            JSONObject.class, StringBuilder.class, StringBuffer.class};
